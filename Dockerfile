...
#    apt-get install --yes nmap curl iputils-ping psutils net-tools bind9-host bind9utils telnet && \
    apt-get install --yes libssl-dev libcurl4-openssl-dev libc-ares-dev libssl-dev libcurl4-openssl-dev libxml2-dev libzip-dev liblz4-dev libzstd-dev libpng-dev && \
    apt-get clean && \
